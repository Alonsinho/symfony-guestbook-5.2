...
class ConferenceController extends AbstractController
{
    ...
    public function show(Request $request, Conference $conference, CommentRepository $commentRepository, NotifierInterface $notifier,
        string $photoDir)
    {
        $comment = new Comment();
    ...
    private function createConferencesResponse(ConferenceRepository $conferenceRepository, string $templatePath): Response
    {
